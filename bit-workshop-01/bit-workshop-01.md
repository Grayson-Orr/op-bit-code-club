...
- Remove git submodule - `git rm --cached <submodule name>`, delete the submodule from the `.gitmodules` file, `git submodule deinit <submodule name>`, commit & delete remove `<submodule name>` directory in `.git/modules`
